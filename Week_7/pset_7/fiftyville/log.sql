...
-- Find out where they escaped to --
...
-- Find who's the accomplice --
SELECT phone_number FROM people
WHERE name = "Bruce";
-- | (367) 555-5533 | to id who was the caller shortly after the theft
