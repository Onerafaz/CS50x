...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const userEmailInput = document.querySelector('#userEmail'); // Assuming the input has an id 'user-email'
  const userNameMessage = document.querySelector('.userName-message');
  const userEmailMessage = document.querySelector('.userEmail-message'); // Assuming the message element has a class 'user-email-message'
