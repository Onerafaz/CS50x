...
def register():
    ...
    if request.method == "POST":
        ...
        username_available = check_username_availability(user_name)
        if not username_available:
            return apology("username not available")

        # Check email availability
        email_available = check_email_availability(user_email)
        ...
        # Add rows into Database
            ...
            try:
                ...
                # If error is returned it means username or email is already taken
...
def check_availability():
    username = request.args.get("username")  # Change to 'username' for consistency with your frontend code
