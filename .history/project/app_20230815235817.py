    ...
    if request.method == "POST":
        ...
        # Add rows into Database
            ...
            try:
                ...
                if "Error executing SQL command: UNIQUE constraint failed: users.email" in str(e):
                    return apology("Email already registered")
                elif "Error executing SQL command: UNIQUE constraint failed: users.name" in str(e):
